...
public sealed class CloneTests
{
    ...
    private Person clone;
        [TestInitialize] public void TestInitialize() 
            => clone = Abc.Aids.Clone.Object(person);
    ...
    [TestMethod] public void NotSameAddressTest() 
        => Assert.AreNotSame(person.Address, clone.Address);

    [TestMethod] public void SamePersonNameTest() 
        => Assert.AreEqual(person.Name, clone.Name);

    [TestMethod] public void SameCityTest() 
